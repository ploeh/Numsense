...
Also, please follow the [Open Source Contribution Etiquette](http://tirania.org/blog/archive/2010/Dec-31.html). Numsense is a fairly typical open source project: if you want to contribute, start by [creating a fork](http://help.github.com/fork-a-repo) and [sending a pull request](http://help.github.com/send-pull-requests) when you have something you wish to commit. When creating pull requests, please keep the Single Responsibility Principle in mind. A pull request that does a single thing well is more likely to be accepted. See also the articles [The Rules of the Open Road](http://blog.half-ogre.com/posts/software/rules-of-the-open-road) and [10 tips for better Pull Requests](http://blog.ploeh.dk/2015/01/15/10-tips-for-better-pull-requests) for more tips on working with OSS and Pull Requests.
