...
[<InlineData(
    23456,
    "двадесет-и-три-хиляди-четиристотин-петдесет-и-шест")>]
[<InlineData(
    56789,
    "петдесет-и-шест-хиляди-седемстотин-осемдесет-и-девет")>]
[<InlineData(
    98765,
    "деветдесет-и-осем-хиляди-седемстотин-шестдесет-и-пет")>]
[<InlineData(
    876540,
    "осемстотин-седемдесет-и-шест-хиляди-петстотин-и-четиридесет")>]
[<InlineData(
    5004621,
    "пет-милиона-четири-хиляди-шестстотин-двадесет-и-едно")>]
[<InlineData(
    6982001,
    "шест-милиона-деветстотин-осемдесет-и-две-хиляди-и-едно")>]
[<InlineData(
    9099000,
    "девет-милиона-деветдесет-и-девет-хиляди")>]
[<InlineData(
    39020011,
    "тридесет-и-девет-милиона-двадесет-хиляди-и-единадесет")>]
[<InlineData(
    64000098,
    "шестдесет-и-четири-милиона-деветдесет-и-осем")>]
[<InlineData(
    70003190,
    "седемдесет-милиона-три-хиляди-сто-и-деветдесет")>]
[<InlineData(
    99000099,
    "деветдесет-и-девет-милиона-деветдесет-и-девет")>]
[<InlineData(
    439011000,
    "четиристотин-тридесет-и-девет-милиона-и-единадесет-хиляди")>]
[<InlineData(
    System.Int32.MaxValue,
