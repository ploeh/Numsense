...
//[<InlineData(       666, "шестотин-шестдесет-и-шест")>]
...
//[<InlineData(      1066, "хиляда-честдесет-и-чест")>]
...
//[<InlineData(     10000, "десет-хиляди-и-едно")>]
//[<InlineData(     12001, "дванадесет-хиляди-и-едно")>]
...
//[<InlineData( 800116000, "осемстотин-милиона-и-сто-и-шестнадесет-хиляди")>]
//[<InlineData( 900800007, "деветстотин-милиона-осемстотин-хиляди-и-седем")>]
//[<InlineData(1000000000, "милиард")>]
//[<InlineData(2121000000, "два-милиарда-и-сто-двадесет-и-един-милиона")>]
//[<InlineData(
//    23456,
