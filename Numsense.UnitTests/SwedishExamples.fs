...
[<InlineData(                       "ettusenfemhundrasextiofyra",       1564)>]
[<InlineData(                         "tusenfemhundrasextiofyra",       1564)>]
[<InlineData(                           "femtonhundrasextiofyra",       1564)>]
[<InlineData(                          "nittonhundrasjuttioåtta",       1978)>]
...
[<InlineData(                           "tjugotvåtusenhundrafem",      22105)>]
...
[<InlineData(                                           "miljon",    1000000)>]
[<InlineData(                                      "enmiljonett",    1000001)>]
[<InlineData(                                       "enmiljonen",    1000001)>]
[<InlineData(                                   "tvåmiljonertio",    2000010)>]
[<InlineData(                            "tvåmiljonerettusentio",    2001010)>]
[<InlineData(                              "tvåmiljonertusentio",    2001010)>]
...
[<InlineData(                                "enmiljardenmiljon", 1001000000)>]
[<InlineData(                                  "enmiljardmiljon", 1001000000)>]
