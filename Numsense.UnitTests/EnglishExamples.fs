...
[<InlineData("ninemilliontwohundredonethousandsixhundredthirtyfour",    9201634)>]
[<InlineData(                                          "tenmillion",   10000000)>]
[<InlineData(                                      "tenmillionnine",   10000009)>]
[<InlineData(                                    "twentyonemillion",   21000000)>]
[<InlineData( "fortysevenmillioneighthundredthirtyonethousandsixty",   47831060)>]
[<InlineData(                                      "hundredmillion",  100000000)>]
[<InlineData(                                   "onehundredmillion",  100000000)>]
[<InlineData(                               "twohundredfivemillion",  205000000)>]
[<InlineData("fourhundredeightyninemillionsixtythousandfivehundred",  489060500)>]
[<InlineData(                                          "onebillion", 1000000000)>]
[<InlineData(                                          "twobillion", 2000000000)>]
[<InlineData("twobillionfortythreemillioneighthundredsixtythousand", 2043860000)>]
[<InlineData(
